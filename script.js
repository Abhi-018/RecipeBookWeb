document.addEventListener("DOMContentLoaded", function () {
  ...
  saveRecipeButton.addEventListener("click", function () {
    ...
    if (recipeName && recipeIngredients && recipeCategory && imageFile) {
        ...
        alert("Please enter a name, ingredients, category, and select an image for the recipe.");
    }
});
  ...
  function addRecipeToList(recipe, index) {
    ...
    recipeItem.style.backgroundImage = `url(${recipe.image})`;
